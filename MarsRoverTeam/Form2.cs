...
namespace MarsRoverTeam
{
    ...
    {
        public static int xLocationLast = 0;
        public static int yLocationLast = 0;
        public static string route_1Last = null;
        public static int xLocation2Last = 0;
        public static int yLocation2Last = 0;
        public static string route_2Last = null;
        ...
        private void PictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            using (Font myFont = new Font("Arial", 12))
            {
                if (Form1.route_1 == "N")
                {
                    e.Graphics.DrawString("R1⬆", myFont, Brushes.Green, new Point(Form1.xLocation, Form1.yLocation));
                }
                ...
                if (Form1.route_2 == "N")
                {
                    e.Graphics.DrawString("R2⬆", myFont, Brushes.Green, new Point(Form1.xLocation2, Form1.yLocation2));
                }
